...
const stripePromise = loadStripe("pk_test_51SMnKeQikMFRjGqcNU5COIIigJj6hKn328DC5sVjAZXAFzpLUIe5cMSTewPKA6VW0V92PnBs34nuOuOmP73amYoL00f7Y6qg5X");
        ...
        <ul className="space-y-2">
          {cart.map((item, i) => (
            <li key={i} className="flex justify-between">
              <span>{item.alt} (Size: {item.size}) x {item.quantity}</span>
